...
export function RichText({
  ...
  return (
    ...
    <div className="flex max-h-[82vh] min-h-[32rem] flex-col overflow-hidden rounded-md border border-zinc-700 bg-zinc-900 transition-colors focus-within:border-orange/50">
