...
import { FOOTER_LINKS, LOCATIONS } from "@/lib/agency";
      ...
      <div className="shell relative z-10">
        ...
        <div className="grid12 gap-x-8 gap-y-12 py-[clamp(3rem,5vw,4.5rem)]">
          ...
          <div className="col-span-12 md:col-span-4">
            ...
            <form className="mt-7 flex max-w-xs items-center border border-line-invert focus-within:border-orange">
              <input
                type="email"
                required
              ...
              <button
                ...
                className="flex h-11 w-11 shrink-0 items-center justify-center bg-orange text-on-orange transition-colors hover:bg-orange-press"
              >
          ...
          {Object.entries(FOOTER_LINKS).map(([group, links]) => (
            <div key={group} className="col-span-6 md:col-span-2">
              <span className="label mb-5 block text-on-ink-3">{group}</span>
